...
output:
  html_document: 
    ...
    highlight: espresso 
params:
  reference_fasta: "data/db/hsv1/ref.fasta"
  input_db_xlsx: "data/db/hsv1/old/2024-08-22_hsv1.resistance.xlsx"
  output_db_xlsx: "data/db/hsv1/resistances.chk.xlsx"
  #reference_fasta: "data/db/hsv2/ref.fasta"
  #input_db_xlsx: "data/db/hsv2/old/2024-08-15_HSV2_DB_AM.xlsx"
  #output_db_xlsx: "data/db/hsv2/resistances.chk.xlsx"
---
...
```{r}
vars <- c("CHROM","AA.POS","AA.REF","AA.ALT","CODON_LOC","CODON.FASTA","AA.FASTA","is_valid_strain_id","is_valid_ref_aa","aa_chg_bcsq","is_valid_transition","is_valid_overall","is_dna_mutation","is_valid_ref_dna","DNA.FASTA","is_aa_mutation","is_valid_snp_transition","dna_chg_bcsq")
...
c("strain_id","drug","mutation_type") |>
  setdiff(names(db_res)) |>
  enframe(name = NULL,value = "colname") |>
  knitr::kable(caption="Liste des colonnes manquantes")
```
...
## Generated output
```{r}
if (!is.null(params$output_db_xlsx) && (params$output_db_xlsx!="")) {
  openxlsx::write.xlsx(list(resistances=db_res),params$output_db_xlsx,overwrite = TRUE)  
  message(str_glue("Name of the generated excel file: {params$output_db_xlsx}"))
} else {
