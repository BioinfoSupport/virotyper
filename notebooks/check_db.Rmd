...
params:
  ...
  #input_db_xlsx: "data/db/hsv1/resistances.chk.xlsx"
  reference_fasta: "data/db/hsv2/ref.fasta"
  input_db_xlsx: "data/db/hsv2/resistances.chk.xlsx"
  output_db_xlsx: ""
---
...
if (!is.null(params$output_db_xlsx) && (params$output_db_xlsx!="")) {
  ...
  message(str:glue("Name of the generated excel file: {params$output_db_xlsx}"))
} else {
